...
import interfaceAdmin from "../assets/images/stock/interfaceAdmin.png";
...
const services_data = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: `The dashboard serves as the administrator’s home page, providing a clear overview of the system’s key data. Through intuitive, color-coded cards, the administrator can quickly view the total number of items, zones, registered users, and overall stock.

                      This visual design enables immediate understanding of the system’s status, with “more info” links offering access to detailed views. The structured left-side menu (Users, Stock, Items, Zones, Details) ensures smooth and organized navigation, supporting efficient and centralized system management.`,
      },
      {
        img: G_article,
